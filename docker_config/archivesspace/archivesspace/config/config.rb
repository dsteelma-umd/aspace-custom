...
# The final commit request at the end of an index round takes a long time (~20 minutes)
# Set read timeout to a high value (40 minutes) as timeout request trigger duplicate requests
# causing performance issues.
AppConfig[:indexer_thread_count] = 4
AppConfig[:indexer_solr_timeout_seconds] = 2400
#
## PUI Indexer Settings
#AppConfig[:pui_indexer_enabled] = true
AppConfig[:pui_indexing_frequency_seconds] = 120
